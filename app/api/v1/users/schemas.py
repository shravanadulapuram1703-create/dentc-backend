...
# ==================================================
# GROUP MEMBERSHIP METADATA SCHEMAS
# ==================================================

class GroupMembershipOption(BaseModel):
    """Single group membership option for metadata APIs"""
    code: str
    name: str
    description: Optional[str] = None
...
class GroupMembershipsMetadataResponse(BaseModel):
    """Response schema for GET /api/v1/users/groups-metadata"""
    groups: List[GroupMembershipOption]
...
class UserCreateRequest(BaseModel):
    ...
    group_memberships: Optional[List[str]] = []  # e.g. ["GRP-001", "GRP-002"]
...
class UserAccessResponse(BaseModel):
    ...
    organizations: List[OrganizationAccessUI]
    offices: List[OfficeAccessUI]
