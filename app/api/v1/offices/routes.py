...
def update_office(
    ...
    logger.info(f"db: {db}")
    logger.info(f"payload.officeId: {payload.officeId}")
    logger.info(f"payload.officeName: {payload.officeName}")
    logger.info(f"payload.shortId: {payload.shortId}")
    logger.info(f"payload.address: {payload.address}")
    logger.info(f"payload.contact: {payload.contact}")
    logger.info(f"payload.billing: {payload.billing}")
    logger.info(f"payload.settings: {payload.settings}")
    logger.info(f"payload.integrations: {payload.integrations}")
    logger.info(f"payload.statementMessages: {payload.statementMessages}")
    logger.info(f"payload.statementSettings: {payload.statementSettings}")
    logger.info(f"payload.operatories: {payload.operatories}")
    logger.info(f"payload.schedule: {payload.schedule}")
    logger.info(f"payload.holidays: {payload.holidays}")
    logger.info(f"payload.advanced: {payload.advanced}")
    logger.info(f"payload.smartAssist: {payload.smartAssist}")
    logger.info(f"payload.created_by: {payload.created_by}")
    logger.info(f"payload.created_date: {payload.created_date}")
    logger.info(f"payload.modified_by: {payload.modified_by}")
    logger.info(f"payload.modified_at: {payload.modified_at}")
